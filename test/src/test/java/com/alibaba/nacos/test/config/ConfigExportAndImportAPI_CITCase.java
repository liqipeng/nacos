...
public class ConfigExportAndImportAPI_CITCase {
    ...
    public void setUp() throws Exception {
        ...
        prarm.put("type", "yaml");
        Assert.assertEquals("true", httpClient.post(serverAddr + CONFIG_CONTROLLER_PATH, prarm, null));
    ...
    public void testExportByIds() {
        ...
        String queryResult = httpClient.get(serverAddr + CONFIG_CONTROLLER_PATH + getDataUrl, null);
        ...
        byte[] zipData = httpClient.download(serverAddr + CONFIG_CONTROLLER_PATH + exportByIdsUrl, null);
    ...
    public void testImport() {
        ...
        String importResult = httpClient.post(serverAddr + CONFIG_CONTROLLER_PATH + importUrl, importPrarm,
        ...
        queryResult = httpClient.get(serverAddr + CONFIG_CONTROLLER_PATH + getDataUrl, null);
    ...
    public void testExportV2() {
        ...
        String queryConfigDetailResult = httpClient.get(
